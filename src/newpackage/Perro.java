...
private boolean showing;
    public Perro(int energia, int hambre, int sed, int felicidad, int fuerza, int suciedad,
            String nombre, JLabel datos, int ganasDeCagar, JLabel jLabel7, JLabel jLabel6, JProgressBar uno,
...
public void setShowing(boolean showing) {
    ...
    @Override
     public void run() {
        while (corriendo == true) {
            ...
            ganasDeCagar -= (int) (Math.random() * 2 + 5);
            if (showing == true) {
                ...
                siete.setValue(ganasDeCagar);
            }
            if (mostrar == true) {
                if (energia <= 0 || hambre <= 0 || sed <= 0 || felicidad <= 0 || fuerza <= 0 || suciedad <= 0 || ganasDeCagar <= 0) {
                    energia = 0;
                    hambre = 0;
                    sed = 0;
                    felicidad = 0;
                    ...
                    instanciaG.setText("<html><p>" + nombre + "</p><p>energia " + energia + "</p><p>hambre " + hambre + "</p><p>sed " + sed + "</p><p>felicidad" + felicidad + "</p><p>fuerza " + fuerza + "</p><p>suciedad " + suciedad + "</p><p>ganas de cagar " + ganasDeCagar + "</html>");
                    vivo = false; //bandera pa no mostrar el panel
                    corriendo = false;
                    stop();
                    break;
                } else if (energia < 50 || hambre < 50 || sed < 50 || felicidad < 50 || fuerza < 50 || suciedad < 50 || ganasDeCagar < 50) {
                     jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(190,190, Image.SCALE_SMOOTH)));
                } else if (energia > 50 || hambre > 50 || sed > 50 || felicidad > 50 || fuerza > 50 || suciedad > 50 || ganasDeCagar > 50) {
                     jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel6.getWidth(), jLabel6.getHeight(), Image.SCALE_SMOOTH)));
                }
                instanciaG.setText("<html><p>" + nombre + "</p><p>energia " + energia + "</p><p>hambre " + hambre + "</p><p>sed " + sed + "</p><p>felicidad" + felicidad + "</p><p>fuerza " + fuerza + "</p><p>suciedad " + suciedad + "</p><p>ganas de cagar " + ganasDeCagar + "</html>");
            } else {
                if (energia <= 0 || hambre <= 0 || sed <= 0 || felicidad <= 0 || fuerza <= 0 || suciedad <= 0 || ganasDeCagar <= 0) {
    ...
    public void setearEnergia() {
        ...
        if ((energia += 10) > 90) {
            ...
            if (energia < 50) {
                 jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(jLabel6.getWidth(), jLabel6.getHeight(), Image.SCALE_SMOOTH)));
            } else if (energia > 50) {
                 jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel6.getWidth(), jLabel6.getHeight(), Image.SCALE_SMOOTH)));
            }
    ...
    public void setearAtributoExt() {
        corriendo = false;
        if ((ganasDeCagar += 10) > 90) {
            ganasDeCagar = 100;
        } else {
            if (ganasDeCagar < 50) {
               jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroTriste.jpeg").getImage().getScaledInstance(jLabel6.getWidth(), jLabel6.getHeight(), Image.SCALE_SMOOTH)));
            } else if (ganasDeCagar > 50) {
                 jLabel7.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel7.getWidth(), jLabel7.getHeight(), Image.SCALE_SMOOTH)));
                    jLabel6.setIcon(new ImageIcon(new ImageIcon("src/pqimg/perroFeliz.jpeg").getImage().getScaledInstance(jLabel6.getWidth(), jLabel6.getHeight(), Image.SCALE_SMOOTH)));
            }
        }
   ...
   public String ilusionInstantanea(){
       return "<html><p>" + nombre + "</p><p>energia " + energia + "</p><p>hambre " + hambre + "</p><p>sed " + sed + "</p><p>felicidad" + felicidad + "</p><p>fuerza " + fuerza + "</p><p>suciedad " + suciedad + "</p><p>ganas De Cagar " + ganasDeCagar + "</html>";
   }
    public int getGanasDeCagar() {
        return ganasDeCagar;
    }
